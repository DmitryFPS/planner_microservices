package ru.orlov.micro.planner.utils.resttemplate;
...
@Component
public class RestTemplateClientImpl {
    private static final String baseUrl = "http://localhost:8082/planner-users/user/";
    ...
    public boolean userExists(final Long userId) {
        ...
        final HttpEntity<Long> request = new HttpEntity<>(userId);
